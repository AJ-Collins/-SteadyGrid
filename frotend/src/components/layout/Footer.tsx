...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-white text-[#0B1525] font-sans border-t border-neutral-200">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 pb-16">
          ...
          <div className="md:col-span-1 flex flex-col">
            ...
            <Link to="/" className="flex items-center gap-2 mb-8">
              <div className="w-8 h-8 rounded bg-[#22a055] flex items-center justify-center text-black font-extrabold text-lg">
                ⚡
              </div>
              <div className="flex flex-col">
                <span className="font-black text-xl text-[#0B1525] tracking-tighter leading-none">
                  STEADYGRID
                </span>
            ...
            {/* Social Icons */}
            <div className="flex items-center gap-4 mt-12 text-[#0B1525]">
              <a href="#" className="hover:text-[#22a055] transition-colors" aria-label="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <a href="#" className="hover:text-[#22a055] transition-colors" aria-label="Facebook">
              ...
              <a href="#" className="hover:text-[#22a055] transition-colors" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href="#" className="hover:text-[#22a055] transition-colors" aria-label="Instagram">
          ...
          <div className="md:col-span-1">
            <h4 className="font-bold text-[13px] text-[#0B1525] mb-4">Navigate</h4>
            <ul className="flex flex-col gap-2.5 text-[12px] text-neutral-500">
              {navigateLinks.map(link => (
                <li key={link}><a href="#" className="hover:text-[#0B1525] transition-colors">{link}</a></li>
              ))}
            </ul>
          </div>
          ...
          {/* Column 3: Categories */}
          <div className="md:col-span-1">
            <h4 className="font-bold text-[13px] text-[#0B1525] mb-4">Categories</h4>
            <ul className="flex flex-col gap-2.5 text-[12px] text-neutral-500">
          ...
          {/* Column 4: Brands */}
          <div className="md:col-span-1">
            <h4 className="font-bold text-[13px] text-[#0B1525] mb-4">Brands</h4>
            <ul className="flex flex-col gap-2.5 text-[12px] text-neutral-500">
              {brandsLinks.map((link, idx) => (
                <li key={link}>
                  <a href="#" className={`hover:text-[#0B1525] transition-colors ${idx === brandsLinks.length - 1 ? 'font-bold text-[#0B1525]' : ''}`}>
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div className="md:col-span-1 flex flex-col justify-between">
            <div>
              <h4 className="font-bold text-[13px] text-[#0B1525] mb-4">My Account</h4>
              <ul className="flex flex-col gap-2.5 text-[12px] text-neutral-500">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-[11px] text-neutral-500">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="hover:text-[#0B1525] transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#0B1525] transition-colors">Legal</a>
            <a href="#" className="hover:text-[#0B1525] transition-colors">Cookies Policy</a>
          </div>
        </div>
